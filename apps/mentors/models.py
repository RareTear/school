...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(
        verbose_name='Полное имя', max_length=255, help_text='Sultan Ergeshev', db_index=True, unique=True,
    )
    phone_number = models.CharField(
        verbose_name="Номер телефона", max_length=11, unique=True, help_text='+996558200441', null=True, blank=True
    )
    ...
    is_staff = models.BooleanField(verbose_name='Сотрудник', default=True, null=True, blank=True)
